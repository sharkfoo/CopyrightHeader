...
namespace CopyrightHeaderExtension
{
    ...
    internal sealed class CopyrightHeaderCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("a5899842-10f4-4857-aacd-47552851d824");
        ...
        private CopyrightHeaderCommand(Package package)
        {
        ...
        {
            Instance = new CopyrightHeaderCommand(package);
        }
